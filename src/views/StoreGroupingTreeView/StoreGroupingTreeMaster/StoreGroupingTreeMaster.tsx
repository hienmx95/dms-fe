...
import StoreGroupingPreview from 'views/StoreGroupingTreeView/StoreGroupingTreeMaster/StoreGroupingTreePreview';
          ...
          render(id: number, storeGrouping: StoreGrouping) {
            return (
              <div className="d-flex justify-content-center button-action-table">
                ...
                {!storeGrouping.used && validAction('delete') &&
