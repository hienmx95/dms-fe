...
import { KPI_ITEM_DETAIL_ROUTE } from 'config/route-consts';
...
import KpiItemPreview from '../KpiItemPreview/KpiItemPreview';
...
function KpiItemViewMaster() {
  ...
  const [
    ...
    setIsReset,
    handleDefaultSearch,
  ] = crudService.useMaster<KpiItem, KpiItemFilter>(
    KpiItem,
    KpiItemFilter,
  ...
  const [handleDelete] = tableService.useDeleteHandler<KpiItem>(
  ...
  const columns: ColumnProps<KpiItem>[] = React.useMemo(
    () => {
      return [
        {
          ...
          render: renderMasterIndex<KpiItem>(pagination),
        },
        {
          title: translate('kpiItems.kpiItemType'),
          key: nameof(list[0].kpiItemType),
          dataIndex: nameof(list[0].kpiItemType),
          sorter: true,
          sortOrder: getOrderTypeForTable<KpiItem>(
        ...
        {
          title: translate('kpiItems.employee.displayName'),
  ...
  return (
    <div className="page master-page">
      <Card title={translate('kpiItems.master.title')} className="header-title">
        <CollapsibleCard
            ...
            <Row>
                ...
                <Col className="pl-1" span={6}>
                  ...
                  >
                    <AdvancedIdFilter
                      ...
                      onChange={handleFilter(nameof(filter.kpiItemTypeId))}
                      getList={kpiItemRepository.filterListKpiItemType}
              ...
              {validAction('filterListAppUser') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('kpiItems.employee.displayName')}
                    labelAlign="left"
                  >
                    <AdvancedIdFilter
...
export default KpiItemViewMaster;
