...
export class PriceListOwnerRepository extends Repository {
  constructor() {
    super(httpConfig);
  ...
  public countNew = (priceListFilter?: PriceListFilter): Promise<number> => {
    return this.http
      .post<number>(kebabCase(nameof(this.countNew)), priceListFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };
  ...
  public listNew = (
    ...
    return this.http
      .post<PriceList[]>(kebabCase(nameof(this.listNew)), priceListFilter)
      .then((response: AxiosResponse<PriceList[]>) => {
        return response.data?.map((priceList: PureModelData<PriceList>) =>
          PriceList.clone<PriceList>(priceList),
        );
      });
  };
  ...
  public countPending = (
    ...
    return this.http
      .post<number>(kebabCase(nameof(this.countPending)), priceListFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };
  ...
  public listPending = (
    ...
    return this.http
      .post<PriceList[]>(kebabCase(nameof(this.listPending)), priceListFilter)
      .then((response: AxiosResponse<PriceList[]>) => {
        return response.data?.map((priceList: PureModelData<PriceList>) =>
          PriceList.clone<PriceList>(priceList),
        );
  ...
  public countCompleted = (
    ...
    return this.http
      .post<number>(kebabCase(nameof(this.countCompleted)), priceListFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };
  ...
  public listCompleted = (
    ...
    return this.http
      .post<PriceList[]>(kebabCase(nameof(this.listCompleted)), priceListFilter)
      .then((response: AxiosResponse<PriceList[]>) => {
        return response.data?.map((priceList: PureModelData<PriceList>) =>
          PriceList.clone<PriceList>(priceList),
        );
  ...
  public send = (priceList: PriceList): Promise<PriceList> => {
    return this.http
      .post<PriceList>(kebabCase(nameof(this.send)), priceList)
      .then((response: AxiosResponse<PriceList>) =>
        PriceList.clone<PriceList>(response.data),
      );
  };

  public approve = (priceList: PriceList): Promise<PriceList> => {
    return this.http
      .post<PriceList>(kebabCase(nameof(this.approve)), priceList)
      .then((response: AxiosResponse<PriceList>) =>
        PriceList.clone<PriceList>(response.data),
      );
  };

  public reject = (priceList: PriceList): Promise<PriceList> => {
    return this.http
      .post<PriceList>(kebabCase(nameof(this.reject)), priceList)
      .then((response: AxiosResponse<PriceList>) =>
        PriceList.clone<PriceList>(response.data),
      );
  };
...
export const priceListOwnerRepository: PriceList = new PriceListOwnerRepository();
