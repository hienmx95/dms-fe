...
import PriceListStoreTypeMapping from '../PriceListOwnerDetail/PriceListMappingTabs/PriceListStoreMappingTab/PriceListStoreTypeMapping';
import PriceListStoreGroupingMapping from '../PriceListOwnerDetail/PriceListMappingTabs/PriceListStoreMappingTab/PriceListStoreGroupingMapping';
import PriceListStoreMappingTable from '../PriceListOwnerDetail/PriceListMappingTabs/PriceListStoreMappingTab/PriceListStoreMappingTable';
import PriceListItemMappingTable from '../PriceListOwnerDetail/PriceListMappingTabs/PriceListItemMappingTab/PriceListItemMappingTable';
    ...
    >
      <Spin spinning={previewLoading}>
        <Descriptions column={2}>
          ...
          <Descriptions.Item label={translate('priceLists.salesOrderType')}>
            {model?.salesOrderType?.name}
          </Descriptions.Item>
