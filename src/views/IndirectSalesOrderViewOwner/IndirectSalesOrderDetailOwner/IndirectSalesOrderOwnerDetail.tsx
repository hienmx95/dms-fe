...
import { AppUser } from 'models/Survey/AppUser';
...
import IndirectSalesOrderContentTable from './IndirectSalesOrderContentTable/IndirectSalesOrderContentTable';
import './IndirectSalesOrderOwnerDetail.scss';
import IndirectSalesOrderPromotionTable from './IndirectSalesOrderPromotionTable/IndirectSalesOrderPromotionTable';
...
function IndirectSalesOrderOwnerDetail() {
  ...
  const [
    ...
    IndirectSalesOrder,
    indirectSalesOrderOwnerRepository.get,
    indirectSalesOrderOwnerRepository.save,
    indirectSalesOrderOwnerRepository.send,
    indirectSalesOrderOwnerRepository.approve,
    indirectSalesOrderOwnerRepository.reject,
  );
  ...
  const [editPriceStatusList] = crudService.useEnumList<EditPriceStatus>(
    indirectSalesOrderOwnerRepository.singleListEditPriceStatus,
  );

  // const [indirectSalesOrderStatusList] = crudService.useEnumList<IndirectSalesOrderStatus>(indirectSalesOrderOwnerRepository.singleListIndirectSalesOrderStatus);
  ...
  const [, , , listStore2] = crudService.useContentModal(
    indirectSalesOrderOwnerRepository.listStore,
    indirectSalesOrderOwnerRepository.countStore,
    StoreFilter,
  );
    ...
    if (calculateTotal) {
      ...
      if (
        ...
        if (newSubTotal && indirectSalesOrder.generalDiscountPercentage) {
          generalDiscountAmount = Number((indirectSalesOrder.generalDiscountPercentage / 100) * newSubTotal);
        } else {
          generalDiscountAmount = indirectSalesOrder.generalDiscountAmount;
        }


        let newTotal = newSubTotal - (generalDiscountAmount !== undefined ? generalDiscountAmount : 0);
  ...
  const handleOpenBuyerStore = React.useCallback(() => {
    if (typeof indirectSalesOrder.saleEmployeeId === 'undefined') {
      Modal.warning({
        title: '',
  ...
  const handleSavePopupBuyerStore = React.useCallback(
    event => {
      ...
      setIndirectSalesOrder({
        ...
        sellerStoreId: event[0].parentStoreId ? event[0].parentStoreId : undefined,
  ...
  const handleChangeGeneralDiscountPercentage = React.useCallback(
    debounce(event => {
      ...
      let discountAmount = Number((percent / 100) * indirectSalesOrder?.subTotal);
  ...
  const handleChangeSaleEmployee = React.useCallback((saleEmployeeId, saleEmployee) => {
    setIndirectSalesOrder({
      ...indirectSalesOrder,
      saleEmployeeId,
      saleEmployee,
      ...
      <Spin spinning={loading}>
            ...
            <Row>
              <Col lg={8}>
                ...
                >
                  ...
                  <Input
                    type="text"
                    value={indirectSalesOrder.phoneNumber}
                    className="form-control form-control-sm"
                    onChange={handleChangeSimpleField(
                      nameof(indirectSalesOrder.phoneNumber),
                    )}
              ...
              <Col lg={8}>
                {validAction('singleListAppUser') && (
                  ...
                  >
                    ...
                    <SelectAutoComplete
                      ...
                      getList={indirectSalesOrderOwnerRepository.singleListAppUser}
                ...
                >
                  ...
                  <Input
                    type="text"
                    value={indirectSalesOrder.deliveryAddress}
                    className="form-control form-control-sm"
                    onChange={handleChangeSimpleField(
                      nameof(indirectSalesOrder.deliveryAddress),
                    )}
              ...
              <Col lg={8}>
                {validAction('listStore') && (
                  ...
                  >
                    ...
                    {indirectSalesOrder?.requestStateId === 1 && (
                      <div className="input-store ant-form-item" onClick={handleOpenBuyerStore}>
                        <span>
                          <Tooltip
                            placement="topLeft"
                      ...
                      indirectSalesOrder.requestStateId === 3) && (
                        <div className="search-container">
                          <Input
                            ...
                            value={indirectSalesOrder.buyerStore?.name}
                            disabled
                          />
                          <i
                ...
                {validAction('listStore') && (
                  ...
                  >
                    ...
                    {indirectSalesOrder?.requestStateId === 1 && (
                      <div className="input-store ant-form-item" onClick={handleOpenResellerStore}>
                        <span>
                          <Tooltip
                            placement="topLeft"
                      ...
                      indirectSalesOrder.requestStateId === 3) && (
                        <div className="search-container">
                          <Input
                            ...
                            value={indirectSalesOrder.sellerStore?.name}
                            disabled
                          />
                          <i
                            className="fa fa-list-alt search-icon"
        ...
        {visibleBuyerStore && (
          <StoreModal
            ...
            getList={indirectSalesOrderOwnerRepository.listBuyerStore}
            count={indirectSalesOrderOwnerRepository.countBuyerStore}
        ...
        {visibleResellerStore && (
          <StoreModal
            ...
            getList={indirectSalesOrderOwnerRepository.listStore}
            count={indirectSalesOrderOwnerRepository.countStore}
            onSave={handleSavePopupResellerStore}
            setResetFilter={setResetFilter}
            resetFilter={resetFilter}
            buyerId={indirectSalesOrder?.buyerStore?.id}
          />
        )}
        {
          isDetail && (
...
export default IndirectSalesOrderOwnerDetail;
