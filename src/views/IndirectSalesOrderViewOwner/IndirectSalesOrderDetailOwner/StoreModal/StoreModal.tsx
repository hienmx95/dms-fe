...
function StoreModal<T extends Model>(props: ContentModalProps<T>) {
  ...
  const [idFilter, setIdFilter] = React.useState<boolean>(true);
  ...
  const [
    ...
    total,
    setLoadList,
  ] = indirectSalesOrderOwnerService.useStoreContentMaster(
    getList,
    count,
    saleEmployeeId,
  );
  ...
  React.useEffect(() => {
    ...
    setLoading(false);
    if (buyerId && idFilter) {
      filterStore.id.notEqual = buyerId;
      setFilterStore(filterStore);
      setIdFilter(false);
    }
  }, [
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={
                      indirectSalesOrderOwnerRepository.singleListStoreGrouping
                    }
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={
                      indirectSalesOrderOwnerRepository.singleListStoreType
                    }
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedTreeFilter
                    ...
                    getList={
                      indirectSalesOrderOwnerRepository.filterListOrganization
                    }
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    onChange={handleChangeFilter(
                      nameof(filterStore.storeStatusId),
                    )}
                    getList={
