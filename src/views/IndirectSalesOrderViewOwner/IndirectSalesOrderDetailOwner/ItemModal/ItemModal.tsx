...
function ItemModal<T extends Model>(props: ContentModalProps<T>) {
  ...
  const {
    ...
    isReset,
    setIsReset,
  } = indirectSalesOrderOwnerService.useModalMaster(
    filter,
    setFilter,
    loadList,
    setloadList,
    indirectSalesOrderOwnerRepository.listItem,
    indirectSalesOrderOwnerRepository.countItem,
    onSave,
  );
              ...
              {/* <Col className="pl-1" span={8}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={
                      indirectSalesOrderOwnerRepository.singleListSupplier
                    }
              ...
              <Col className="pl-1" span={8}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={indirectSalesOrderOwnerRepository.filterListBrand}
                ...
                <Col className="pl-1" span={8}>
                  ...
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={
                        indirectSalesOrderOwnerRepository.filterListCategory
                      }
              ...
              <Col className="pl-1" span={8}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={
                      indirectSalesOrderOwnerRepository.singleListProductType
                    }
              ...
              <Col className="pl-1" span={8}>
                ...
                >
                  <AdvancedTreeFilter
                    ...
                    getList={
                      indirectSalesOrderOwnerRepository.singleListProductGrouping
                    }
                    modelFilter={productTypeFilter}
                    setModelFilter={setProductTypeFilter}
                    placeholder={translate('general.placeholder.title')}
