...
export class IndirectSalesOrderOwnerService {
  ...
  public useItemModal(
    ...
    }, [currentStore, filterItem, setVisible, model, translate, setFirstTime]);
...
export const indirectSalesOrderOwnerService: IndirectSalesOrderOwnerService = new IndirectSalesOrderOwnerService();
