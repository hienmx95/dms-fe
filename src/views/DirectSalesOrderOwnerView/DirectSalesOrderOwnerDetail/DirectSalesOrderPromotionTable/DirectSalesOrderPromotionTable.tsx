...
function DirectSalesOrderPromotionTable(
  ...
  const [
    ...
    ,
    handleDelete,
  ] = crudService.useContentTable<DirectSalesOrder, DirectSalesOrderPromotion>(
    model,
    setModel,
    nameof(model.directSalesOrderPromotions),
  );
        ...
        if (
          ...
          if (event === undefined || event === null) {
            ...
            requestedQuantitys = Number(
              Number(event) * directSalesOrderPromotions[index].factor,
            );
          }
          directSalesOrderPromotions[index] = {
            ...directSalesOrderPromotions[index],
          ...
          return (
            ...
            >
              <InputNumber
                ...
                disabled={
                  !directSalesOrderPromotion?.unitOfMeasure?.id ||
                ...
                {validAction('listItem') && (
                  <>
                    ...
                    <button
                      ...
                      disabled={!selectedPromotions.length || model.requestStateId === 2 || model.requestStateId === 3}
