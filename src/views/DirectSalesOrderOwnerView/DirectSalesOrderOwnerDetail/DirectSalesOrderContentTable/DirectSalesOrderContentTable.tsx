...
export interface DirectSalesOrderContentTableProps
  ...
  setCalculateTotalAfterTax?: Dispatch<SetStateAction<boolean>>;
...
function DirectSalesOrderContentTable(
  ...
  const handleChangeTaxType = React.useCallback(
    ...
    [setCalculateTotalAfterTax, directSalesOrderContents, setDirectSalesOrderContents],
  );
  ...
  const handleDelete = React.useCallback(
    ...
    [directSalesOrderContents, setDirectSalesOrderContents, setCalculateTotalAfterTax],
  );
            ...
            <>
              ...
              >
                <InputNumber
                  ...
                  disabled={
                    !directSalesOrderContent?.unitOfMeasure?.id ||
    ...
    if (changeEditPrice === true && directSalesOrderContents.length > 0) {
      directSalesOrderContents.forEach(
        (content: DirectSalesOrderContent, index: number) => {
          ...
          directSalesOrderContents[index].salePrice =
            newSalePrice * directSalesOrderContents[index].factor;
                ...
                {validAction('listItem') && (
                  <>
                    ...
                    <button
                      ...
                      disabled={!selectedContents.length || model.requestStateId === 2 || model.requestStateId === 3}
                    >
