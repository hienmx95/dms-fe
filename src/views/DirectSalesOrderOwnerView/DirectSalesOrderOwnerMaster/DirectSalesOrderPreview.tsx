    ...
    >
      ...
      <Spin spinning={previewLoading}>
        ...
        <Descriptions column={2}>
          <Descriptions.Item className="float-right" label={translate('directSalesOrders.promotionValue')}>{formatNumber(directSalesOrder?.promotionValue)}</Descriptions.Item>
          <Descriptions.Item className="float-right" label={translate('directSalesOrders.promotionCode')}>{directSalesOrder?.promotionCode}</Descriptions.Item>
        </Descriptions>
        <Descriptions column={1}>
