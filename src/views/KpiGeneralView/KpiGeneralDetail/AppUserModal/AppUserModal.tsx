...
function AppUserModal(props: AppUserModalProps) {
  ...
  const {
    ...
    loadList,
    setloadList,
    kpiGeneralRepository.listAppUser,
    kpiGeneralRepository.countAppUser,
    onSave,
  );
  ...
  const [selectedListAppUser, setSelectedListAppUser] = React.useState<AppUser[]>([]);
          ...
          <Form>
            <Row>
              <Col className="pl-1" span={6}>
                <FormItem
                  className="mb-0"
                  label={translate('kpiGenerals.appUser.displayName')}
                  labelAlign="left"
                >
                  <AdvancedStringFilter
                    ...
                    placeholder={translate('kpiGenerals.appUser.placeholder.displayName')}
                    className="w-100"
                  />
                </FormItem>
              </Col>
              <Col className="pl-1" span={6}>
                <FormItem
                  className="mb-0"
                  label={translate('kpiGenerals.appUser.username')}
                  labelAlign="left"
                >
                  <AdvancedStringFilter
                    ...
                    placeholder={translate('kpiGenerals.appUser.placeholder.username')}
                    className="w-100"
                  />
                </FormItem>
              </Col>
              <Col className="pl-1" span={6}>
                <FormItem
                  className="mb-0"
                  label={translate('kpiGenerals.appUser.email')}
                  labelAlign="left"
                >
                  <AdvancedStringFilter
                    ...
                    placeholder={translate('kpiGenerals.appUser.placeholder.email')}
                    className="w-100"
                  />
                </FormItem>
              </Col>
              <Col className="pl-1" span={6}>
                <FormItem
                  className="mb-0"
                  label={translate('kpiGenerals.appUser.phone')}
                  labelAlign="left"
                >
                  <AdvancedStringFilter
                    ...
                    placeholder={translate('kpiGenerals.appUser.placeholder.phone')}
                    className="w-100"
                  />
                </FormItem>
              </Col>
