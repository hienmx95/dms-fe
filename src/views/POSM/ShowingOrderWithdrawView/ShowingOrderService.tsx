...
export class ShowingOrderService {
  ...
  public useItemModal(
    ...
    const handleOpenModal = useCallback(() => {
      ...
      if (
        model?.showingOrderContentWithDraws &&
        model?.showingOrderContentWithDraws?.length > 0
      ) {
        const selectedShowingItem = model.showingOrderContentWithDraws.map(
