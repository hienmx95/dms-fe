...
function ItemModal<T extends Model>(props: ContentModalProps<T>) {
  ...
  const {
    ...
    loadList,
    setloadList,
    showingOrderWithdrawRepository.listShowingItem,
    showingOrderWithdrawRepository.countShowingItem,
    onSave,
  );
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedIdFilter
                    ...
                    getList={
                      showingOrderWithdrawRepository.filterListUnitOfMeasure
                    }
              ...
              <Col className="pl-1" span={6}>
                ...
                >
                  <AdvancedTreeFilter
                    ...
                    getList={
                      showingOrderWithdrawRepository.filterListShowingCategory
                    }
