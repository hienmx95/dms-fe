...
import { SHOWING_ORDER_WITHDRAW_DETAIL_ROUTE } from 'config/route-consts';
...
import ShowingOrderWithdrawPreview from './ShowingOrderWithdrawPreview';

const { Item: FormItem } = Form;

function ShowingOrderWithdrawMaster() {
  ...
  const [
    ...
    ShowingOrder,
    ShowingOrderFilter,
    showingOrderWithdrawRepository.count,
    showingOrderWithdrawRepository.list,
  ...
  const [handleExport] = crudService.useExport(
    showingOrderWithdrawRepository.export,
    filter,
  );

  const [handleDelete] = tableService.useDeleteHandler<ShowingOrder>(
    showingOrderWithdrawRepository.delete,
    setLoading,
    list,
    setList,
    handleDefaultSearch,
  ...
  const [handleBulkDelete] = tableService.useBulkDeleteHandler(
    ...
    showingOrderWithdrawRepository.bulkDelete,
    setLoading,
    handleDefaultSearch,
  );
  ...
  React.useEffect(() => {
    if (loadItem) {
      showingOrderWithdrawRepository
  ...
  const columns: ColumnProps<ShowingOrder>[] = React.useMemo(
    () => {
      return [
        ...
        {
          title: translate('showingOrdersWithdraw.total'),
  ...
  return (
    <div className="page master-page">
      <Card title={translate('showingOrdersWithdraw.master.title')}>
        <CollapsibleCard
                ...
                {validAction('filterListOrganization') && (
                  ...
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={
                        showingOrderWithdrawRepository.filterListOrganization
                      }
                ...
                {validAction('filterListStore') && (
                  ...
                  >
                    <AdvancedIdFilter
                      ...
                      getList={showingOrderWithdrawRepository.filterListStore}
                ...
                {validAction('filterListShowingItem') && (
                  ...
                  >
                    <AdvancedIdMultiFilter
                      ...
                      getList={
                        showingOrderWithdrawRepository.filterListShowingItem
                      }
                ...
                {validAction('filterListAppUser') && (
                  ...
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={showingOrderWithdrawRepository.filterListAppUser}
                ...
                {validAction('filterListStatus') && (
                  ...
                  >
                    <AdvancedIdFilter
                      ...
                      getList={showingOrderWithdrawRepository.singleListStatus}
        ...
        /> */}
        <ShowingOrderWithdrawPreview
          previewModel={previewModel}
          previewLoading={previewLoading}
          previewVisible={previewVisible}
          onClose={handleClosePreview}
          list={previewModel?.showingOrderContentWithDraws}
        />
      </Card>
    </div>
  );
...
export default ShowingOrderWithdrawMaster;
