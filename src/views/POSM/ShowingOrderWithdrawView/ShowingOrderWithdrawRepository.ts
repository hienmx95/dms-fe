...
import { ShowingOrderWithdrawFilter } from 'models/posm/ShowingOrderWithdrawFilter';
...
export class ShowingOrderWithdrawRepository extends Repository {
  constructor() {
    super(httpConfig);
    this.setBaseURL(url(API_BASE_URL, API_SHOWING_ORDER_WITHDRAW_ROUTE));
  }

  public count = (
    showingOrderFilter?: ShowingOrderWithdrawFilter,
  ): Promise<number> => {
    return this.http
  ...
  public list = (
    showingOrderFilter?: ShowingOrderWithdrawFilter,
  ): Promise<ShowingOrderWithdraw[]> => {
    return this.http
      .post<ShowingOrderWithdraw[]>(
        kebabCase(nameof(this.list)),
        showingOrderFilter,
      )
      .then((response: AxiosResponse<ShowingOrderWithdraw[]>) => {
        return response.data?.map(
          (showingOrder: PureModelData<ShowingOrderWithdraw>) =>
            ShowingOrderWithdraw.clone<ShowingOrderWithdraw>(showingOrder),
        );
      });
  };

  public get = (id: number | string): Promise<ShowingOrderWithdraw> => {
    return this.http
      .post<ShowingOrderWithdraw>(kebabCase(nameof(this.get)), { id })
      .then((response: AxiosResponse<ShowingOrderWithdraw>) =>
        ShowingOrderWithdraw.clone<ShowingOrderWithdraw>(response.data),
      );
  };

  public create = (
    showingOrder: ShowingOrderWithdraw,
  ): Promise<ShowingOrderWithdraw> => {
    return this.http
      .post<ShowingOrderWithdraw>(kebabCase(nameof(this.create)), showingOrder)
      .then((response: AxiosResponse<PureModelData<ShowingOrderWithdraw>>) =>
        ShowingOrderWithdraw.clone<ShowingOrderWithdraw>(response.data),
      );
  };
  ...
  public update = (
    ...
    return this.http
      .post<ShowingOrderWithdraw>(kebabCase(nameof(this.update)), showingOrder)
      .then((response: AxiosResponse<ShowingOrderWithdraw>) =>
        ShowingOrderWithdraw.clone<ShowingOrderWithdraw>(response.data),
      );
  };
  ...
  public delete = (
    ...
    return this.http
      .post<ShowingOrderWithdraw>(kebabCase(nameof(this.delete)), showingOrder)
      .then((response: AxiosResponse<ShowingOrderWithdraw>) =>
        ShowingOrderWithdraw.clone<ShowingOrderWithdraw>(response.data),
      );
  };
  ...
  public export = (
    filter?: ShowingOrderWithdrawFilter,
...
export const showingOrderWithdrawRepository: ShowingOrderWithdraw = new ShowingOrderWithdrawRepository();
