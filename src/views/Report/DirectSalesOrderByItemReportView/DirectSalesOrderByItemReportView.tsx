...
import { directSalesOrderByItemsRepository } from './DirectSalesOrderByItemRepository';

const { Item: FormItem } = Form;

function DirectSalesOrderByItemReportView() {
  const [translate] = useTranslation();
  const { validAction } = crudService.useAction(
    'direct-sales-order-by-items-report',
    API_DIRECT_SALES_ORDER_BY_ITEM_REPORT_ROUTE,
  );
  const [
    filter,
    setFilter,
    ...
    DirectSalesOrderByItemsReport,
    DirectSalesOrderByItemsReportFilter
  >(
    DirectSalesOrderByItemsReportFilter,
    directSalesOrderByItemsRepository.list,
    directSalesOrderByItemsRepository.count,
    'date',
  );
  ...
  const [totalCount] = reportService.getTitleNumber<
    DirectSalesOrderByItemsReportDataTable,
    DirectSalesOrderByItemsReportFilter
  >(filter, directSalesOrderByItemsRepository.total, isCount, setIsCount);
  ...
  const [handleExport] = crudService.useExport(
    directSalesOrderByItemsRepository.export,
    filter,
  );
  ...
  >[] = React.useMemo(() => {
    return [
      ...
      {
        title: translate('directSalesOrderByItems.itemCode'),
      ...
      {
        title: translate('directSalesOrderByItems.itemName'),
      ...
      {
        title: translate('directSalesOrderByItems.unitOfMeasureName'),
      ...
      {
        title: translate('directSalesOrderByItems.saleStock'),
      ...
      {
        title: translate('directSalesOrderByItems.promotionStock'),
      ...
      {
        title: translate('directSalesOrderByItems.discount'),
      ...
      {
        title: translate('directSalesOrderByItems.revenue'),
      ...
      {
        title: translate('directSalesOrderByItems.directSalesOrderCounter'),
      ...
      {
        title: translate('directSalesOrderByItems.buyerStoreCounter'),
  ...
  return (
    <div className="page master-page kpi-report-master">
      <Card
        title={translate('directSalesOrderByItems.master.title')}
          ...
          <Form>
            <Row>
              {validAction('filterListOrganization') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderByItems.organization')}
                    labelAlign="left"
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={
                        directSalesOrderByItemsRepository.filterListOrganization
                      }
              ...
              {validAction('filterListProductGrouping') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderByItems.productGrouping')}
                    labelAlign="left"
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={
                        directSalesOrderByItemsRepository.filterListProductGrouping
                      }
              ...
              {validAction('filterListProductType') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderByItems.productType')}
                    labelAlign="left"
                  >
                    <AdvancedIdFilter
                      ...
                      getList={
                        directSalesOrderByItemsRepository.filterListProductType
                      }
              ...
              {validAction('filterListItem') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderByItems.item')}
                    labelAlign="left"
                  >
                    <AdvancedIdFilter
                      ...
                      getList={directSalesOrderByItemsRepository.filterListItem}
            ...
            <Row>
              <Col className="pl-1" span={6}>
                <FormItem
                  className="mb-0"
                  label={translate('directSalesOrderByItems.time')}
                  labelAlign="left"
                >
                  <AdvancedDateFilter
                    filter={dateFilter}
                    ...
                    placeholder={[
                      translate(
                        'directSalesOrderByItems.placeholder.startDate',
                      ),
                      translate('directSalesOrderByItems.placeholder.endDate'),
                    ]}
                  />
                </FormItem>
              </Col>
...
const transformMethod = (itemm: DirectSalesOrderByItemsReport) => {
  const datalist = [];
  // fist record is title record
  datalist[0] = {
    ...new DirectSalesOrderByItemsReportDataTable(),
    title: itemm.organizationName,
    key: uuidv4(),
    rowSpan: 1,
  };
  itemm.itemDetails?.forEach(
    (itemDetails: DirectSalesOrderByItemsReportDataTable) => {
      const {
        organizationName,
        itemCode,
        itemName,
...
const renderCell = (
  value: any,
  record: DirectSalesOrderByItemsReportDataTable,
  colIndex: number,
  colNumber?: number,
  rowIndex?: number,
...
export default DirectSalesOrderByItemReportView;
