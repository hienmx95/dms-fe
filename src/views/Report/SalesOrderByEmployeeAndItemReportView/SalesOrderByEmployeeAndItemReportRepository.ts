...
export class SalesOrderByEmployeeAndItemReportRepository extends Repository {
  constructor() {
    super(httpConfig);
    this.setBaseURL(
      url(API_BASE_URL, API_SALES_ORDER_BY_EMPLOYEE_AND_ITEM_REPORT_ROUTE),
    );
  }
  public count = (
...
export const salesOrderByEmployeeAndItemReportRepository: SalesOrderByEmployeeAndItemReportRepository = new SalesOrderByEmployeeAndItemReportRepository();
