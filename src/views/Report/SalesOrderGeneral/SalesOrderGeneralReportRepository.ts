...
export class SalesOrderGeneralReportRepository extends Repository {
  constructor() {
    super(httpConfig);
    this.setBaseURL(url(API_BASE_URL, API_SALES_ORDER_GENERAL_ROUTE));
  }
...
export const salesOrderGeneralReportRepository: SalesOrderGeneralReportRepository = new SalesOrderGeneralReportRepository();
