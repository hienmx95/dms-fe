...
import '../../Report.scss';
import { directSalesOrderGeneralReportRepository } from './DirectSalesOrderGeneralReportRepository';
const { Item: FormItem } = Form;
function DirectSalesOrderGeneralReportView() {
  const [translate] = useTranslation();
  const { validAction } = crudService.useAction(
    'direct-sales-order-general-report',
    API_DIRECT_SALES_ORDER_GENERAL_ROUTE,
  );
  const [
    filter,
    setFilter,
  ...
  >(
    SalesOrderGeneralReportFilter,
    directSalesOrderGeneralReportRepository.list,
    directSalesOrderGeneralReportRepository.count,
    'orderDate',
  );
  ...
  const [totalCount] = reportService.getTitleNumber<
    ...
    SalesOrderGeneralReportFilter
  >(filter, directSalesOrderGeneralReportRepository.total, isCount, setIsCount);
  ...
  const [handleExport] = crudService.useExport(
    directSalesOrderGeneralReportRepository.export,
    filter,
  );
    ...
    return [
      {
        ...
        render(...[, record, rowIndex]) {
          ...
          return renderCell(value, record, 0, 12, rowIndex, 6, record.rowSpan);
        },
      },
      {
        title: translate('directSalesOrderGenerals.code'),
      ...
      {
        title: translate('directSalesOrderGenerals.buyerStoreName'),
      ...
      {
        title: translate('directSalesOrderGenerals.buyerStoreStatusName'),
      ...
      {
        title: translate('directSalesOrderGenerals.saleEmployeeName'),
      ...
      {
        title: translate('directSalesOrderGenerals.orderDate'),
      ...
      {
        title: translate('directSalesOrderGenerals.subTotal'),
      ...
      {
        title: translate('directSalesOrderGenerals.discount'),
      ...
      {
        title: translate('directSalesOrderGenerals.taxValue'),
      ...
      {
        title: translate('directSalesOrderGenerals.revenue'),
      ...
      {
        title: translate('directSalesOrderGenerals.promotionValue'),
        key: nameof(dataList[0].promotionValue),
        dataIndex: nameof(dataList[0].promotionValue),
        ellipsis: true,
        width: 150,
        align: 'right',
        render(...[promotionValue, record, rowIndex]) {
          let value = promotionValue;
          if (rowIndex === 0) {
            value = record.promotionValue;
          }
          return renderCell(value, record, 11, 0, rowIndex, 1, 1);
        },
      },
      {
        title: translate('directSalesOrderGenerals.totalAfterPromotion'),
        key: nameof(dataList[0].totalAfterPromotion),
        dataIndex: nameof(dataList[0].totalAfterPromotion),
        ellipsis: true,
        width: 150,
        align: 'right',
        render(...[totalAfterPromotion, record, rowIndex]) {
          let value = totalAfterPromotion;
          if (rowIndex === 0) {
            value = record.totalAfterPromotion;
          }
  ...
  return (
    <div className="page master-page kpi-report-master">
      <Card
        title={translate('directSalesOrderGenerals.master.title')}
          ...
          <Form>
            <Row>
              {validAction('filterListOrganization') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderGenerals.organization')}
                    labelAlign="left"
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={
                        directSalesOrderGeneralReportRepository.filterListOrganization
                      }
              ...
              {validAction('filterListAppUser') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderGenerals.saleEmployee')}
                    labelAlign="left"
                  >
                    <AdvancedIdFilter
                      ...
                      getList={
                        directSalesOrderGeneralReportRepository.filterListAppUser
                      }
              ...
              {validAction('filterListStore') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    className="mb-1"
                    label={translate('directSalesOrderGenerals.buyerStoreName')}
                    labelAlign="left"
                  >
                    <AdvancedIdFilter
                      ...
                      getList={
                        directSalesOrderGeneralReportRepository.filterListStore
                      }
              ...
              {validAction('filterListStoreStatus') && (
                <Col className="pl-1" span={6}>
                  <FormItem
                    ...
                    className="mb-1"
                    label={translate(
                      'directSalesOrderGenerals.buyerStoreStatusName',
                    )}
                  >
                    <AdvancedIdFilter
                      ...
                      getList={
                        directSalesOrderGeneralReportRepository.filterListStoreStatus
                      }
            ...
            <Row>
              <Col className="pl-1" span={6}>
                <FormItem
                  className="mb-0"
                  label={translate('directSalesOrderGenerals.time')}
                  labelAlign="left"
                >
                  <AdvancedDateFilter
                    filter={dateFilter}
                    ...
                    placeholder={[
                      translate(
                        'directSalesOrderGenerals.placeholder.startDate',
                      ),
                      translate('directSalesOrderGenerals.placeholder.endDate'),
                    ]}
                  />
                </FormItem>
              </Col>
...
export default DirectSalesOrderGeneralReportView;
