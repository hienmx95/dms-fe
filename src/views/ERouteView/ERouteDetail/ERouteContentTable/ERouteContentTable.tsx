...
function ERouteContentTable(props: ERouteContentTableProps) {
  ...
  const {
    ...
    filter,
    setFilter,
  } = modalService.useModal(StoreFilter);
    ...
    return [
      {
        ...
        children: [
          ...
          },
          {
            ...
            dataIndex: nameof(dataSource[0].store),
            ellipsis: true,
            render(store: Store, content: ERouteContent) {
              return (
                <>
                  <div
                    className={classNames(
                      { errors: content.errors?.store },
                      { '': !content.errors?.store },
                    )}
                  >
                    {store?.name}
                  </div>
        ...
        children: [
          {
            ...
            width: 50,
            render(monday: boolean, content: ERouteContent, index: number) {
              return (
                <>
                  <Checkbox
