...
export class ERouteOwnerRepository extends Repository {
  constructor() {
    super(httpConfig);
  ...
  public import = (
    ...
    formData.append(`eRouteId`, `${filter.id.equal}`);
    return this.http
  ...
  public countNew = (eRouteFilter?: ERouteFilter): Promise<number> => {
    return this.http
      .post<number>(kebabCase(nameof(this.countNew)), eRouteFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };

  public listNew = (eRouteFilter?: ERouteFilter): Promise<ERoute[]> => {
    return this.http
      .post<ERoute[]>(kebabCase(nameof(this.listNew)), eRouteFilter)
      .then((response: AxiosResponse<ERoute[]>) => {
        return response.data?.map((eRoute: PureModelData<ERoute>) =>
          ERoute.clone<ERoute>(eRoute),
        );
  ...
  public countPending = (eRouteFilter?: ERouteFilter): Promise<number> => {
    return this.http
      .post<number>(kebabCase(nameof(this.countPending)), eRouteFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };

  public listPending = (eRouteFilter?: ERouteFilter): Promise<ERoute[]> => {
    return this.http
      .post<ERoute[]>(kebabCase(nameof(this.listPending)), eRouteFilter)
      .then((response: AxiosResponse<ERoute[]>) => {
        return response.data?.map((eRoute: PureModelData<ERoute>) =>
          ERoute.clone<ERoute>(eRoute),
        );
  ...
  public countCompleted = (eRouteFilter?: ERouteFilter): Promise<number> => {
    return this.http
      .post<number>(kebabCase(nameof(this.countCompleted)), eRouteFilter)
      .then((response: AxiosResponse<number>) => response.data);
  };

  public listCompleted = (eRouteFilter?: ERouteFilter): Promise<ERoute[]> => {
    return this.http
      .post<ERoute[]>(kebabCase(nameof(this.listCompleted)), eRouteFilter)
      .then((response: AxiosResponse<ERoute[]>) => {
        return response.data?.map((eRoute: PureModelData<ERoute>) =>
          ERoute.clone<ERoute>(eRoute),
        );
  ...
  public export = (eRoute?: ERoute): Promise<AxiosResponse<any>> => {
    return this.http.post('export', eRoute, {
  ...
  public exportTemplate = (
    ...
    return this.http.post('export-template', eRoute, {
      responseType: 'arraybuffer',
    });
  };
}

export const eRouteOwnerRepository: ERoute = new ERouteOwnerRepository();
