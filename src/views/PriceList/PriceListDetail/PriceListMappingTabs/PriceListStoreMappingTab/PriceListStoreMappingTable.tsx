...
export default function PriceListStoreMappingTable(
  ...
  const {
    ...
    handleChange,
    handleClick,
  } = priceListService.useImport<PriceListStoreMappings>(
        ...
        children: [
          {
            title: () => (
              <AdvancedStringFilter
                ...
                className="w-100"
                placeholder={translate('priceLists.store.code')}
              />
            ),
        ...
        children: [
          {
            title: () => (
              <AdvancedIdFilter
                ...
                getList={priceListRepository.singleListStoreType}
        ...
        children: [
          {
            title: () => (
              <AdvancedIdFilter
                ...
                getList={priceListRepository.singleListProvince}
        ...
        children: [
          {
            title: () => (
              <AdvancedIdFilter
                ...
                getList={priceListRepository.singleListStoreGrouping}
