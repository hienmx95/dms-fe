...
import {
  PriceListMappingModalState,
  priceListService,
} from 'views/PriceList/PriceListService';
...
export default function PriceListItemMappingModal(
  ...
  const {
    ...
    pagination,
    handleTableChange,
  } = priceListService.usePriceListMappingModal<Item, ItemFilter>(
    ItemFilter,
    loadList,
    setLoadList,
    onSave,
    onClose,
    priceListRepository.listItem,
    priceListRepository.countItem,
    defaultState,
    selectedList,
    setSelectedList,
  );
                ...
                <Col className="pl-1" span={11}>
                  ...
                  >
                    <AdvancedTreeFilter
                      ...
                      getList={priceListRepository.singleListProductGrouping}
                ...
                <Col className="pl-1" span={11}>
                  ...
                  >
                    <AdvancedIdFilter
                      ...
                      getList={priceListRepository.singleListProductType}
