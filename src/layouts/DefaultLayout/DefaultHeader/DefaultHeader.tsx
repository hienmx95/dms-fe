...
import { DASHBOARD_USER_ROUTE } from 'config/route-consts';
...
function DefaultHeader(props: HeaderProps) {
  ...
  const {
    ...
    unreadNotification,
  } = useDefaultHeader(user as AppUser, signalRContext, SIGNALR_CHANNEL);
      ...
      >
        ...
        <div className="actions d-flex">
          ...
          >
            ...
            <DropdownMenu>
              <DropdownItem header>Thông báo</DropdownItem>
        ...
        <div className="notification ml-1 d-flex align-items-center align-content-center pt-2 pb-2">
          {unread === true ? (
            <>
              ...
              {siteId === 5 && (
                <div className="icon-noti-mdm ml-1 mr-3">
                  <i className="tio-shop_outlined" />
                </div>
              )}
              {siteId === 6 && (
                <div className="icon-noti-ams ml-1 mr-3">
                  <i className="tio-shop_outlined" />
                </div>
              )}
